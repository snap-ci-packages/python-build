...
This repo contains scripts needed to build deb and rpms for various versions of python. To report any issues, [please contact the Snap.ci support team](https://snap-ci.com/contact-us).
