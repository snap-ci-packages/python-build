...
%w(2.6.8 2.7.5 3.1.5 3.2.5 3.3.2).each do |version|
  namespace version do
    ...
    task :init do
      ...
      mkdir_p "downloads"
      mkdir_p "jailed-root"
      sh('gpg --recv-keys 6A45C816 36580288 7D9DC8D2 18ADD4FF A4135B38 A74B06BF EA5BBD71 ED9D77D5 E6DF025C F73C700D')
    end
